...
diabetes_model = pickle.load(open(r"C:\Users\aaksh\Desktop\MediPredict-main\MediPredict-main\models\diabetes_model_new.sav",'rb'))
heart_model = pickle.load(open(r"MediPredict-main/models/heart_disease_model.sav",'rb'))
parkinsons_model = pickle.load(open("MediPredict-main//models//parkinsons_model.sav",'rb'))
breast_model = pickle.load(open(r"C:\Users\aaksh\Desktop\MediPredict-main\MediPredict-main\models\breast_cancer_model.sav",'rb'))
